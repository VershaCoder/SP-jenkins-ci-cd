...
</html>''', mimeType: 'text/html', replyTo: 'vershamishra01@gmail.com', subject: 'Feature - Branch : Pipeline Status : ${BUILD_SUCCESS} #${BUILD_NUMBER}', to: 'vershamishra01@gmail.com'
}
    }
}